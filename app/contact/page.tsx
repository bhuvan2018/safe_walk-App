...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 pt-16 md:pt-24">
      ...
      <div className="container mx-auto px-4 py-8 md:py-16">
        ...
        >
          <div className="grid md:grid-cols-3 gap-8">
            {/* Contact Form */}
            <div className="md:col-span-2 bg-gray-900 rounded-lg p-4 md:p-8 shadow-lg">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-8 text-orange-500">LET'S GET IN TOUCH</h2>
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <Textarea
                  ...
                  className="bg-gray-800 border-gray-700 text-white h-32 md:h-40 w-full"
                  required
                />
                <Button
                  type="submit"
                  className="w-full bg-orange-500 text-white py-2 md:py-3 px-4 md:px-6 rounded-lg hover:bg-orange-600 transition-colors"
            ...
            {/* Contact Information */}
            <div className="bg-orange-500 rounded-lg p-4 md:p-8 text-white">
              <div className="space-y-4 md:space-y-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg">Nehru Nagara, Puttur 574201</p>
                  </div>
                </div>
                <div>
